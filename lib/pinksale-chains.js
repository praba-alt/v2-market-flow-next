export const PINKSALE_CHAIN_CONFIG = {
  ...
  109: {
    ...
    fallbackRpcUrls: ["https://www.shibrpc.com", "https://shib.nownodes.io"],
  ...
  196: {
    ...
    fallbackRpcUrls: ["https://xlayerrpc.okx.com"],
  ...
  250: {
    ...
    fallbackRpcUrls: ["https://fantom-rpc.publicnode.com", "https://fantom.drpc.org"],
  ...
  369: {
    ...
    fallbackRpcUrls: ["https://pulsechain-rpc.publicnode.com"],
  ...
  1116: {
    ...
    fallbackRpcUrls: ["https://core.drpc.org", "https://rpc-core.icecreamswap.com"],
  ...
  2000: {
    ...
    fallbackRpcUrls: ["https://rpc01-sg.dogechain.dog", "https://rpc.ankr.com/dogechain"],
  ...
  3797: {
    ...
    slug: "alvey",
    family: "evm",
    defaultRpcUrl: "https://elves-core1.alvey.io",
    fallbackRpcUrls: ["https://elves-core2.alvey.io", "https://elves-core3.alvey.io"],
  ...
  7000: {
    ...
    fallbackRpcUrls: ["https://zeta-chain.drpc.org", "https://zetachain-mainnet.public.blastapi.io"],
  ...
  7171: {
    ...
    fallbackRpcUrls: ["https://brockrpc.io"],
...
export function getEvmRpcCandidates(chainOrId) {
  const config = getChainConfig(chainOrId);
  if (!config || config.family !== "evm") return [];

  const envUrl = config.rpcEnvVar ? process.env[config.rpcEnvVar] : "";
  const defaults = [config.defaultRpcUrl, ...(config.fallbackRpcUrls || [])];
  const urls = [envUrl, ...defaults].filter(Boolean).map((url) => String(url).trim());
  return [...new Set(urls)];
}
